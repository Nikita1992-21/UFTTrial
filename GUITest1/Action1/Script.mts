Browser("Oracle India | Integrated").Page("Oracle India | Integrated").Link("Menu").Click @@ script infofile_;_ZIP::ssf1.xml_;_
...
Browser("Google").Page("Jenkins example - Google").WebEdit("Search").Set "localhost" @@ script infofile_;_ZIP::ssf8.xml_;_
Browser("Google").Page("Jenkins example - Google").Sync
Browser("Google").Back @@ hightlight id_;_2556390_;_script infofile_;_ZIP::ssf9.xml_;_
